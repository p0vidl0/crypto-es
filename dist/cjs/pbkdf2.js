...
exports.PBKDF2 = exports.PBKDF2Algo = void 0;
 ...
 */
class PBKDF2Algo extends core_js_1.Base {
    /**
    ...
    compute(password, salt) {
        ...
        const { cfg } = this;
        // Init HMAC
        const hmac = hmac_js_1.HMAC.create(cfg.hasher, password);
        // Initial values
        const derivedKey = core_js_1.WordArray.create();
        const blockIndex = core_js_1.WordArray.create([0x00000001]);
        // Shortcuts
