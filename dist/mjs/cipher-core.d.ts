...
export class Cipher extends BufferedBlockAlgorithm {
     ...
     */
    static _createHelper(SubCipher: any): Object;
    /**
...
export namespace Cipher {
    const _ENC_XFORM_MODE: number;
    const _DEC_XFORM_MODE: number;
...
export namespace OpenSSLKdf {
     ...
     */
    function execute(password: string, keySize: number, ivSize: number, salt: string | WordArray): CipherParams;
    /**
     * Derives a key and IV from a password.
     *
     * @param {string} password The password to derive from.
...
export namespace PasswordBasedCipher {
    const cfg_1: Base & {
        ...
        kdf: {
             ...
             *     var derivedParams = CryptoJS.kdf.OpenSSL.execute('Password', 256/32, 128/32, 'saltsalt');
             */
            execute(password: string, keySize: number, ivSize: number, salt: string | WordArray): CipherParams;
        };
    };
    export { cfg_1 as cfg };
}
